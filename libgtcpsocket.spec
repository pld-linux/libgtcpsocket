...
GTcpSocket to obiektowy, wielowątkowy interfejs do funkcji sieciowych
TCP/IP. Daje przezroczystą dla aplikacji obsługę proxy i podstawowego
szyfrowania SSL.
...
Pliki nagłówkowe libgtcpsocket.
